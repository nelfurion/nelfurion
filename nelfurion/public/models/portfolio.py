...
projects = {
    'left': [
         {
            'media_url': '{scheme}://{host}/static/public/img/chatbot2.1.jpg',
            'title': 'Thesis',
            ...
            'background_image': '{scheme}://{host}/static/public/img/jackson.png',
         },
         {
            'media_url': '{scheme}://{host}/static/public/img/hacktues2.2.jpg',
            ...
            'description': 'HackTUES is the first and only Bulgarian high school Hackathon. Running for 4 consecutive years, \
                             ...
                             business environment. Each year more and more students participate with more than 200 students taking part in the 4th edition.',
            'description_type': 'text',
            'additional_info_type': 'html',
            ...
            'background_image': '{scheme}://{host}/static/public/img/hacktues_back.jpg',
         },
         {
            'media_url': '{scheme}://{host}/static/public/img/consistorium.png',
            'title': 'Consistorium',
         ...
         {
            'media_url': '{scheme}://{host}/static/public/img/elsys2.1.png',
         ...
         {
            'media_url': '{scheme}://{host}/static/public/img/blog.png',
         ...
         {
            'media_url': '{scheme}://{host}/static/public/img/intern2.1.jpg',
            'background_image': '{scheme}://{host}/static/public/img/genes.png',
         ...
         {
            'media_url': '{scheme}://{host}/static/public/img/hackfmi.jpg',
            'title': 'HackFMI',
            ...
            'background_image': '{scheme}://{host}/static/public/img/hackfmi_back.jpg',
         },
         {
            'media_url': '{scheme}://{host}/static/public/img/telerik.png',
            'title': 'Graduated the Telerik Software Academy 2016 Ninja Track',
...
more_projects = [{
        'title': 'WoahMe',
        'media_url': '{scheme}://{host}/static/public/img/woahme2.2.jpg',
        ...
        'media_url': '{scheme}://{host}/static/public/img/windows2.3.png',
        ...
        'title': 'Scacrifice',
        'media_url': '{scheme}://{host}/static/public/img/scacrifice2.2.png',
        ...
        'title': 'Arduino-Pong',
        'media_url': '{scheme}://{host}/static/public/img/arduino_pong2.1.jpeg',
        ...
        'title': 'HackTUES 1, 2 Web App',
        'media_url': '{scheme}://{host}/static/public/img/hacktues_small.png',
        'description': 'I took part in building the web apps for the first 2 editions of the hackathon.',
        'link': {
            'url':'https://github.com/nelfurion',
            'title': 'My profile on Github',
        },
        'title_dark': True,
    }, {
        'title': 'RepoCounter',
        'media_url': '{scheme}://{host}/static/public/img/repo_counter.jpg',
...
hackTUES_video = {
    'url': "https://www.youtube.com/embed/wZXVR2lKOng",
    'description': '<p>Video, showing the atmosphere in the first edition of HackTUES.</p>\
                    <p>More than 200 people participated in the last edition of the hackathon.</p>',
    'title': 'HackTUES 1 Video',
}

activities = {
    'reports': [{
        'title': 'Classifying meteor images',
        'thumbnail': '{scheme}://{host}/static/public/icons/monitor.png',
        'description': 'My report, done in cooperation with Bozhidara Stoyanova on the topic of meteor image classification, \
                        at the Bulgarian National Youth Astronomy Conference.'
    }],
    'papers': [{
        'title': 'Chatbot with Machine Learning',
        'thumbnail': '{scheme}://{host}/static/public/icons/paperclip-8x.png',
        'link': 'https://drive.google.com/file/d/0B1L7B58PaEK6V2tGb2UzQ0tETDQ/view?usp=sharing',
    }]
}
